...
import { Upload as UploadIcon, FileUp, X, LogOut } from "lucide-react";
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              >
                ...
                <div className="text-sm font-medium">{file ? file.name : (isMobile ? "Tap to select a file" : "Drop a file here or click to browse")}</div>
